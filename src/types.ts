...
export interface SiteConfig { siteName: string; tagline: string; repository: string; locale: string; theme: "light" | "dark" | "system"; modules: Record<ModuleKey, boolean>; profile: { headline: string; bio: string } }
