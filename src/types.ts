...
export interface BaseRecord { id: number; type: ModuleKey; title: string; issueUrl: string; state: "open" | "closed"; archived: boolean; labels: string[]; createdAt: string; updatedAt: string; activityDate: string }
